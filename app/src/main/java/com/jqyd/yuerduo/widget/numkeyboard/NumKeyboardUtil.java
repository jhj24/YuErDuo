...
public class NumKeyboardUtil {
    ...
    public NumKeyboardUtil(Activity activity) {
        this(activity, false);
    }

    public NumKeyboardUtil(Activity activity, boolean ifRandom) {
        this.mActivity = activity;
        this.mIfRandom = ifRandom;
        mKeyboardNumber = new Keyboard(mActivity, R.xml.keyboard_number);
        mKeyboardView = (NumKeyboard) mActivity.findViewById(R.id.keyboard_view);
    }
