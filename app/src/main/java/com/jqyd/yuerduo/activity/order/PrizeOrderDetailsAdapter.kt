...
class PrizeOrderDetailsAdapter(private val activity: PrizeOrderDetailActivity, var orderBean: OrderBean?, private val recyclerView: RecyclerView, var type: Int) : RecyclerView.Adapter<PrizeOrderDetailsAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val inflate: View
//        if (type == 4) {
//            inflate = LayoutInflater.from(parent.context).inflate(R.layout.layout_delivery_order_details_list_item, parent, false)
//        } else {
        inflate = LayoutInflater.from(parent.context).inflate(R.layout.layout_order_details_list_item, parent, false)
//        }
