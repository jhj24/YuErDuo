...
/**
 * 订单详情商品列表adapter
 * Created by lll on 2015/12/21.
 */
class OrderDetailsAdapter(private val activity: OrderDetailActivity, var orderBean: OrderBean?, private val recyclerView: RecyclerView, var type: Int) : RecyclerView.Adapter<OrderDetailsAdapter.MyViewHolder>() {
