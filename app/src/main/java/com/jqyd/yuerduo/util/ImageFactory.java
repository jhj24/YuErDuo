...
/**
 * Created by zhangfan on 16-7-4.
 */
public class ImageFactory {


    public static void compressAndGenImageWithResize(String imgPath, String outPath, int maxSize, int reqWidth, int reqHeight, boolean needsDelete) throws IOException {
        compressAndGenImage(readResizeBitmap(imgPath, reqWidth, reqHeight), outPath, maxSize);
    ...
    private static Bitmap readResizeBitmap(String imgPath, int reqWidth, int reqHeight) {
...
//        }
        ...
        // 把options.inJustDecodeBounds 设为 false,这次图片是要读取出来的。
